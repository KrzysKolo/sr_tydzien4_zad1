...
class SectionCard extends Component {
    state = {
     ...
     render() {
        ...
        <FormCard bill={this.state.bill} result={this.state.result} show={this.state.show} handleChange={this.handleChange} handleConvert={this.handleConvert} onSubmit={this.onSubmit} />
