...
class SectionCard extends Component {
    state = {
     ...
     handleConvert = () => {
         const amount = parseFloat(this.state.newBill.amount);
         const tip = parseFloat(this.state.newBill.tip);
         this.setState({
             results: ({amount}*0.08)+({amount}*0.08)*{tip}
         })
        ...
        return (
            <section className="billCard__section">
                ...
                <form>
                    ...
                    <label className="label__BillCard" htmlFfor="form__select">Wybierz wysokość napiwku</label>
